...
% Script to run trial motors and 160Kg of batterys: Expected iridis run time = 6.5 hours
...
generation
    ...
    if generation ~= GA.Generations
        ...
        name = strcat("Winner 160Kg - ",string(cost_ind));
        save(name,'C');
    end
end


save('160Kg-functions','cost');
save('160Kg-results','Gen_Results')
save('160Kg-whole','GA')