...
for t = [WS.delta_T:WS.delta_T:WS.Sim_time]
   ...
   %Calculate Fan PR
    ...
    %Look up fan beta
    beta_Fan = Fan.beta_ID(NL_Normal,Fan_PR);
    ...
    beta_HPC = HPC.beta_ID(NH_Normal,PR_HPC);
    ...
    %Calculate mf_dot
    LCV = 43e6;
    mdot_f = (mdot3_t*(WS.cpe*(T04_now-298)-WS.cp*(T03-298)))/...
        (LCV-WS.cpe*(T04_now-298));
