...
Senario1.Point_Senario = zeros(total_sim_points, 5);
Senario1.Points_fill(WS, HP);

% Step points
WS.Step_time =30;
Senario1.Step_Points = ...
    [0.00,  50,  1e5, 293;...
     10.00, 50,  1e5, 293;...
     10.02, 100, 1e5, 293;...
     20.00, 100, 1e5, 293;...
 ...
 Senario1.Step_Senario = zeros(WS.Step_time/WS.delta_T + 1, 5);
 Senario1.Step_fill(WS, HP);
