function [fuel_mass,Transiant_Time] = Run_Read(Architecture,E_Control, Fan_Map, HPC_Map, Combustor,Bypass, Afterburner)
...
if Afterburner.IsActive == 1
    saveas(gcf,strcat(string(Storage_Capacity/Storage_Power_Density),'KgAB-PowerGraph.png'))
else
    saveas(gcf,strcat(string(Storage_Capacity/Storage_Power_Density),'Kg-PowerGraph.png'))
end
hold off
end 
